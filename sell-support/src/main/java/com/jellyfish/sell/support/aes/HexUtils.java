...
public class HexUtils  {
   ...
   public HexUtils() {
    ...
    public static byte[] decode(final Object object) throws Exception {
        try {
    ...
    public byte[] encode(final byte[] array) throws IOException {
    ...
    public Object encode(final Object object) throws Exception {
        try {
            final byte[] byteArray = object instanceof String ?
                                   ((String) object).getBytes(DEFAULT_CHARSET_NAME) : (byte[]) object;
